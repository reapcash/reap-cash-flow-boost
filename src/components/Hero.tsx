          ...
          <div className="space-y-8">
            <div className="space-y-6 animate-slide-up">
              <h1 className="text-5xl lg:text-6xl leading-tight">
                <span className="text-primary drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Turn your </span>
                <span className="text-primary drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">real estate income</span>
                <span className="text-primary drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]"> into </span>
